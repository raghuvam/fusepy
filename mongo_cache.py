...
class lruCache:
    ...
    def __init__(self, size):
        ...
        # LRU Cache is imlemented using Ordered Dictionaries
    ...
    def put(self, key, value):
        ...
        try:
            ...
            if len(self.cache) < self.size:
                ...
                #pop the least recent used item from the cache dict
                # And insert new incoming value
...
class FileNode:
    ...
    def put(self,key,value):
        ## start time of the put function
        ...
        fdict = {"key":skey, "value":pickle_value}
                
        #first put the file in the cache                  
        lru_cache.put(skey,fdict)
        ...
        print "PUT - RUNTIME--> ", (stop-start)*(1000000)," us"
        
        
        
    def get(self,key):
        
        #GET fucntion start time
        start = timeit.default_timer()
        ...
        if cdict:
            ...
            if "value" in fdict.keys():
                ...
                if not lru_cache.put(skey,fdict):print "Cache is Full"
